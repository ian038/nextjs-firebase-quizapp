                    ...
                    {quiz.questions.map((singleQuiz, index) => {
                        return (
                            ...
                            singleQuiz.options[singleQuiz.answer].optionId ===
                                ...
                                <Text>{index + 1}) {singleQuiz.title}</Text>
                                <RadioGroup>
                                ...
                                <Text mt={3}>Correct Answer: {singleQuiz.options[singleQuiz.answer].title}</Text>
                                {answer.questions[singleQuiz.questionId] ? (
                                    <Text>
                                        Selected Answer:{' '}
                                        {
                                            singleQuiz.options.find(option => option.optionId === answer.questions[singleQuiz.questionId]).title
                                        }
                                    </Text>
                                ) : (
